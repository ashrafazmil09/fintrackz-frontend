    ...
    <div className="relative" style={{ width: size, height: size }}>
      ...
      {editing && (
        <button
          ...
          className="absolute bottom-0 right-0 w-16 h-16 bg-orange-500 rounded-full border-4 border-white"
        >
          <span className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 text-white font-bold text-4xl leading-none">
            +
          </span>
        </button>
      )}
